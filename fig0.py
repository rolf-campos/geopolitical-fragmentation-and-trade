...
def load_data():
    file_path = os.path.join(SOURCE_DATA_DIR, 'fragmentation_0.csv')
...
def fig0(df):
    ...
    axins1.set_yticks([0.0, 0.1, 0.2, 0.3])
    axins1.set_yticklabels(['$0$', '$0.1$', '$0.2$', '$0.3$'], fontsize=8)
...
# df.loc[df['iso_a3']=='RUS', 'W-'] = np.nan
# df['RUS'] = (df['iso_a3'] == 'RUS')
# df.loc[df['iso_a3']!='RUS', 'RUS'] = np.nan
